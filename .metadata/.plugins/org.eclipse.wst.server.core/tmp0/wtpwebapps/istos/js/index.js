...
saveButton.addEventListener('click',function(){ //when the save button is clicked 
	if(responseObj.Title.trim() == ""){ //check if no movie was selected to be saved.
		return
	}
	movieNameParameter.value = responseObj.Title //else set the title of the movie to be saved.
})
